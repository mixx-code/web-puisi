...
<div class="container-buat-puisi">
    ...
    <form action="../../config/controllers/proses_isi_profil.php" method="post" class="card-buat-puisi">
        ...
        <input type="date" name="tanggl_lahir" id="" class="input-puisi" placeholder="Masukkan Tanggal lahir anda">
